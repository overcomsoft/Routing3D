# 자동 배관 라우팅 개발문서 docx 생성기 — docs/routing3d_autorouting_dev_report.md → .docx
# =============================================================================
# [실행]
#   .\.venv\Scripts\python.exe python_experiments/out/_gen_autorouting_dev_report.py
#   → docs/routing3d_autorouting_dev_report.docx 생성
#   이어서 PDF:
#   powershell -ExecutionPolicy Bypass -File python_experiments/out/_docx_to_pdf.ps1 `
#       -In docs/routing3d_autorouting_dev_report.docx -Out docs/routing3d_autorouting_dev_report.pdf
#
# [하는 일]
...
SRC = ROOT / "docs" / "routing3d_autorouting_dev_report.md"
OUT = ROOT / "docs" / "routing3d_autorouting_dev_report.docx"
