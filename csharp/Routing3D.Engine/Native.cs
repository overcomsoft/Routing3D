...
internal static class Native
{
    ...
    [StructLayout(LayoutKind.Sequential)]
    internal struct R3dOctreeLeaf
    {
        public float x0_mm, y0_mm, z0_mm;
        public float size_mm;
        public int state;
    }
    ...
    [DllImport(Dll, CallingConvention = Cdecl)] internal static extern int r3d_set_min_straight_mm(IntPtr e, double mm);
