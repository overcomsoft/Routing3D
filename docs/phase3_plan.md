...
> **다음 즉시 실행 항목** = Step 3.6 (part 4) **계층 corridor**(coarse 경로로 fine 탐색영역 제한, 단일 배관 <1초; 초대형 격자 전역 탐색을 위해 A* g/closed 를 해시 기반으로 확장 필요). 이후 FCL(3.7)/rip-up(3.8)/벤치(3.11)/리포트(3.12).
